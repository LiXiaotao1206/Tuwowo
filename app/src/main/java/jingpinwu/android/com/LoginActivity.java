...
public class LoginActivity extends Activity
{
    ...
    String loginUrl = "http://lxtgoup.web.zhanhi.com/dom/denglu.php?username=lxtgoup&wap=1";
    //String userUrl =  "http://slark.wap.dlszywz.net.cn/dom/sc_user_center.php?username=slark&wap=1";
    String userUrl =  "http://lxtgoup.web.zhanhi.com/dom/sc_user_center.php?username=lxtgoup&wap=1";
    @Override
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState)
    {
        ...
        webSettings.setUserAgentString("Mozilla/5.0 (Linux; Android 10; ZTE A2021 Build/QKQ1.200816.002; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/77.0.3865.120 COVC/045429 Mobile Safari/537.36 MQQBrowser/10.9");
